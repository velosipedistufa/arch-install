...
static const Key keys[] = {
	...
	{ 0, XKB_KEY_XF86AudioRaiseVolume,  spawn, SHCMD("$HOME/.config/waybar/scripts/volume.sh up") },
	{ 0, XKB_KEY_XF86AudioLowerVolume,  spawn, SHCMD("$HOME/.config/waybar/scripts/volume.sh down") },
